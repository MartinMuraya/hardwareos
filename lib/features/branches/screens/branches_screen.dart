...
class _BranchesScreenState extends State<BranchesScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final data =
          await FunctionsService.call('getBranches', {'businessId': bizId});
                    ...
                    : RefreshIndicator(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (_, i) => _BranchCard(
                            ...
                            theme: theme,
                            onTap: () =>
                                context.push('/branches/${_branches[i].id}'),
                          ),
                        ),
                      ),
              ),
...
class _BranchCard extends StatelessWidget {
  ...
  const _BranchCard(
      {required this.branch, required this.theme, required this.onTap});
