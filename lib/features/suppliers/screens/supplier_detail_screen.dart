                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          _InfoRow(
                              label: 'Email',
                              value: _supplier!.email.isNotEmpty
                                  ? _supplier!.email
                                  : '—',
                              theme: theme),
                          _InfoRow(
                          ...
                          _InfoRow(
                              ...
                              value: _supplier!.contactPerson.isNotEmpty
                                  ? _supplier!.contactPerson
                                  : '—',
                              theme: theme),
                          _InfoRow(
                              label: 'Payment Terms',
                              value: _supplier!.paymentTerms,
                              theme: theme),
                          ...
                          Row(children: [
                            ...
                            Text(_fmt.format(_supplier!.currentBalance),
                                style: TextStyle(
                                  ...
                                  fontSize: 16,
                                  color: _supplier!.currentBalance > 0
                                      ? AppColors.warning
                                      : AppColors.success,
                                )),
                          ]),
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () => context.push(
                              '/purchase-orders/add?supplierId=${_supplier!.id}&supplierName=${Uri.encodeComponent(_supplier!.name)}'),
