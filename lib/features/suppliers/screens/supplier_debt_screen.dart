...
class _SupplierDebtScreenState extends State<SupplierDebtScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final resDebts = await FunctionsService.call(
          'getSupplierDebts', {'businessId': bizId});
      final resDash = await FunctionsService.call(
          'getSupplierDebtDashboard', {'businessId': bizId});
      ...
      if (mounted) {
        setState(() {
          _debts = list
              .map((e) =>
                  SupplierDebt.fromMap(Map<String, dynamic>.from(e as Map)))
              .toList();
  ...
  Future<void> _showPaymentDialog(SupplierDebt debt) async {
    ...
    final amountCtrl =
        TextEditingController(text: debt.outstanding.toStringAsFixed(0));
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(
                        labelText:
                            'Reference Code (e.g. M-Pesa Code / Cheque No.)',
                      ),
                    ),
                    const SizedBox(height: 16),
                    TextField(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Supplier Debt & Payables',
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Outstanding Supplier Debts',
                      ...
                      _debts.isEmpty
                          ? const EmptyState(
                              ...
                              subtitle:
                                  'You are all clear with your suppliers!',
                            )
                          : ListView.separated(
                              shrinkWrap: true,
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                              'KES ${debt.outstanding.toStringAsFixed(2)}',
                                              style: const TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 16,
                                                  color: AppColors.error)),
