  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final data = await FunctionsService.call(
          'getDebtDashboard', {'businessId': bizId});
      ...
      if (mounted) {
        setState(() {
          _debtors = debtors;
          _totalOutstanding =
              ((data['totalOutstanding'] as num?) ?? 0).toDouble();
            ...
            if (_loading)
              ...
              Row(children: [
                ...
                _SummaryCard(
                  ...
                  color:
                      _overdueCount > 0 ? AppColors.error : AppColors.success,
                  theme: theme,
                ),
              ]),
                    ...
                    : RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) => CustomerCard(
                            customer: _debtors[i],
                            onTap: () =>
                                context.push('/customers/${_debtors[i].id}'),
                          ),
                        ),
                      ),
              ),
