...
class _CustomerStatementScreenState extends State<CustomerStatementScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final customer =
          Customer.fromMap(Map<String, dynamic>.from(data['customer'] as Map));
                      ...
                      if (_summary != null)
                        Container(
                          ...
                          child: Row(children: [
                            _StatItem(
                                label: 'Total Debt',
                                value: _fmt.format(_summary!['totalDebt'] ?? 0),
                            ...
                            _StatItem(
                                label: 'Total Paid',
                                value: _fmt.format(_summary!['totalPaid'] ?? 0),
                            ...
                            _StatItem(
                                label: 'Balance',
                                value: _fmt
                                    .format(_summary!['currentBalance'] ?? 0),
                                color:
                                    (_summary!['currentBalance'] as num? ?? 0) >
                                            0
                                        ? AppColors.warning
                                        : AppColors.success,
                                theme: theme),
