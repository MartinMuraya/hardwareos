  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final customer = Customer.fromMap(
          Map<String, dynamic>.from(custData['customer'] as Map));
      final rawTxs = (txData['transactions'] as List?) ?? [];
      final txs = rawTxs
          .map((e) =>
              DebtTransaction.fromMap(Map<String, dynamic>.from(e as Map)))
          .toList();
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          TextField(
            controller: noteCtrl,
            decoration: const InputDecoration(
                labelText: 'Note (optional)', hintText: 'e.g. M-Pesa payment'),
          ),
        ]),
        actions: [
          TextButton(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
              ...
              onPressed: () =>
                  context.push('/customers/${widget.customerId}/statement'),
            ),
          ],
        ),
        body: _customer == null
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(children: [
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                              'Fundi • ${_customer!.loyaltyPoints.toInt()} pts',
                          ...
                          Row(children: [
                            _KpiTile(
                                label: 'Balance',
                                value: _fmt.format(_customer!.currentBalance),
                                color: _customer!.currentBalance > 0
                                    ? AppColors.warning
                                    : theme.colorScheme.onSurfaceVariant,
                                theme: theme),
                            ...
                            _KpiTile(
                                label: 'Credit Limit',
                                value: _fmt.format(_customer!.creditLimit),
                                color: _customer!.creditLimit > 0
                                    ? AppColors.info
                                    : theme.colorScheme.onSurfaceVariant,
                                theme: theme),
                            Container(
                            ...
                            _KpiTile(
                                label: 'Available',
                                value: _customer!.creditLimit > 0
                                    ? _fmt.format(_customer!.availableCredit)
                                    : 'Unlimited',
                                color: _customer!.availableCredit > 0 ||
                          ...
                          if (_customer!.isOverLimit) ...[
                            ...
                            Container(
                              ...
                              child: Row(children: [
                                ...
                                Text(
                                    'Over credit limit by ${_fmt.format(_customer!.currentBalance - _customer!.creditLimit)}',
                                    style: const TextStyle(
                      ...
                      if (_transactions.isEmpty)
                        ...
                        ..._transactions.map((tx) => DebtTxTile(
                            transaction: tx, fmt: _fmt, theme: theme)),
                    ]),
              ),
      ),
    );
