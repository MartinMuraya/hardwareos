      ...
      child: Container(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text('Statutory Deduction Rates (%)',
                  style: Theme.of(context).textTheme.titleLarge),
              const SizedBox(height: 8),
              const Text(
                  'Configure the standard rates for payroll generation. These apply globally to all employees.'),
              const SizedBox(height: 24),
              TextFormField(
                initialValue: settings?.payeRate.toString() ?? _paye.toString(),
                decoration: const InputDecoration(
                    labelText: 'PAYE Rate (%)', border: OutlineInputBorder()),
                keyboardType:
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'NHIF Rate (%)', border: OutlineInputBorder()),
                keyboardType:
                    const TextInputType.numberWithOptions(decimal: true),
                validator: (val) =>
                    val == null || val.isEmpty ? 'Required' : null,
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'NSSF Rate (%)', border: OutlineInputBorder()),
                keyboardType:
                    const TextInputType.numberWithOptions(decimal: true),
                validator: (val) =>
                    val == null || val.isEmpty ? 'Required' : null,
              ...
              const SizedBox(height: 8),
              const Text(
                  'Should commissions be calculated as a percentage of Total Revenue, or Gross Profit?'),
              const SizedBox(height: 16),
              DropdownButtonFormField<String>(
                ...
                items: const [
                  DropdownMenuItem(
                      value: 'revenue', child: Text('Total Revenue')),
                  DropdownMenuItem(
                      value: 'profit',
                      child: Text('Gross Profit (Revenue - Cost)')),
                ],
                onChanged: (val) {
