    ...
    final method = await showDialog<String>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
              onPressed: () => Navigator.pop(ctx, 'mpesa'),
          ...
          actions: [
            ...
            if (_quotation != null && _quotation!.status == 'sent')
              PopupMenuButton<String>(
                ...
                itemBuilder: (_) => [
                  const PopupMenuItem(
                      value: 'accepted', child: Text('Mark as Accepted')),
                  const PopupMenuItem(
                      value: 'rejected', child: Text('Mark as Rejected')),
                ],
              ),
          ],
        ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          Row(children: [
                            _InfoChip(
                                label: 'Date',
                                value: _dateFmt.format(_quotation!.createdAt),
                                theme: theme),
                            if (_quotation!.validUntil != null) ...[
                              ...
                              _InfoChip(
                                  label: 'Valid Until',
                                  value:
                                      _dateFmt.format(_quotation!.validUntil!),
                                  theme: theme),
                            ],
                          ]),
                        ]),
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          const Divider(),
                          _QtRow('Subtotal', _fmt.format(_quotation!.subtotal),
                              theme: theme),
                          if (_quotation!.discountAmount > 0)
                            _QtRow('Discount',
                                '-${_fmt.format(_quotation!.discountAmount)}',
...
class _QtRow extends StatelessWidget {
  ...
  final bool bold;
  final ThemeData theme;
  const _QtRow(this.label, this.value,
      {this.color, this.bold = false, required this.theme});
  @override
