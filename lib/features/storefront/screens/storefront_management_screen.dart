...
class StorefrontManagementScreen extends StatefulWidget {
  ...
  @override
  State<StorefrontManagementScreen> createState() =>
      _StorefrontManagementScreenState();
}

class _StorefrontManagementScreenState
    extends State<StorefrontManagementScreen> {
  ...
  Future<void> _loadSettings() async {
    ...
    final defaultBusinessName =
        context.read<AuthProvider>().userProfile?['businessName'] as String? ??
            '';

    try {
      final res = await FunctionsService.call(
          'getStorefrontSettings', {'businessId': bizId});
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (_currentInfo == null || _currentInfo!.tenantSlug != slug) {
        final checkRes = await FunctionsService.call(
            'checkSlugAvailability', {'slug': slug, 'businessId': bizId});
        if (checkRes['available'] != true) {
          throw Exception(
              'The URL "/store/$slug" is already taken. Please choose another.');
        }
      }
  ...
  void _openStorefront() {
    ...
    final Uri url =
        Uri.parse('$currentUrl/#/store/${_currentInfo!.tenantSlug}');
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    const Text('Your Storefront is LIVE!',
                                        style: TextStyle(
                                            color: Colors.white,
                                            fontSize: 18,
                                    ...
                                    Text(
                                        'Customers can visit: /store/${_currentInfo!.tenantSlug}',
                      ...
                      Container(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Storefront Configuration',
                                  style: theme.textTheme.titleLarge
                                      ?.copyWith(fontWeight: FontWeight.bold)),
                              const SizedBox(height: 8),
                              Text(
                                  'Manage your public-facing B2B/B2C online store.',
                                  style: TextStyle(
                                      color:
                                          theme.colorScheme.onSurfaceVariant)),
                              const SizedBox(height: 32),
                              SwitchListTile(
                                title: const Text('Enable Online Storefront',
                                    style:
                                        TextStyle(fontWeight: FontWeight.w600)),
                                subtitle: const Text(
                                    'Turn this off to temporarily hide your store from the public.'),
                                value: _active,
                                onChanged: (val) =>
                              ...
                              TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  ...
                                  helperText:
                                      'This appears at the top of your public store.',
                                ),
                                validator: (v) =>
                              ...
                              TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  ...
                                  helperText:
                                      'Provide a link to your business logo.',
                                ),
                              ),
                              const SizedBox(height: 16),
                              TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  ...
                                  helperText:
                                      'Appears at the top of your catalog.',
                                ),
                              ),
                              const SizedBox(height: 16),
                              TextFormField(
                              ...
                              TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  ...
                                  helperText:
                                      'Include country code, e.g., 254700000000. Leave blank to hide.',
                                ),
                              ),
                              const SizedBox(height: 24),
                              const Divider(height: 48),
                              ...
                              if (_deliveryZones.isEmpty)
                                const Text(
                                    'No delivery zones added. Storefront will be Click & Collect only.',
                                    style: TextStyle(
                                        ...
                                        children: [
                                          Expanded(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: const InputDecoration(
                                                  labelText:
                                                      'Zone Name (e.g. Nairobi CBD)'),
                                              onChanged: (v) =>
                                                  _deliveryZones[index] =
                                                      DeliveryZone(
                                                          id: zone.id,
                                                          name: v,
                                                          fee: zone.fee),
                                          ...
                                          Expanded(
                                            child: TextFormField(
                                              ...
                                              onChanged: (v) => _deliveryZones[
                                                      index] =
                                                  DeliveryZone(
                                                      id: zone.id,
                                                      name: zone.name,
                                                      fee: double.tryParse(v) ??
                                                          0),
                                            ),
                                          ),
                                          IconButton(
