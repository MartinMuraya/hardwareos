  ...
  Future<void> _receive() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
            'This will add all items to inventory and update stock levels. Continue?'),
        actions: [
          TextButton(
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          Row(children: [
                            _InfoChip(
                                label: 'Created',
                                value: _dateFmt.format(_po!.createdAt),
                                theme: theme),
                            if (_po!.receivedAt != null) ...[
                              ...
                              _InfoChip(
                                  label: 'Received',
                                  value: _dateFmt.format(_po!.receivedAt!),
                                  theme: theme),
                            ],
                          ]),
                        ]),
                        ...
                        child: Column(children: [
                          ..._po!.items.map((item) => Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  SizedBox(
                                      width: 80,
                                      child: Text(_fmt.format(item.unitCost),
