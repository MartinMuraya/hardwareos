...
class BarcodePrintService {
  ...
  static Future<Uint8List> generateLabelPdf(Product product, String businessName) async {
        ...
        build: (pw.Context context) {
          return pw.Center(
            child: pw.Column(
              ...
              children: [
                pw.Text(businessName, style: pw.TextStyle(fontSize: 8, fontWeight: pw.FontWeight.bold)),
                pw.SizedBox(height: 2),
                pw.Text(product.name, style: const pw.TextStyle(fontSize: 7), maxLines: 1, overflow: pw.TextOverflow.clip),
                pw.SizedBox(height: 2),
                pw.BarcodeWidget(
                ...
                pw.SizedBox(height: 2),
                pw.Text('KES ${product.sellingPrice.toStringAsFixed(0)}', style: pw.TextStyle(fontSize: 9, fontWeight: pw.FontWeight.bold)),
              ],
            ),
          );
        },
